...
public class frmpelanggan extends javax.swing.JFrame {
    ...
    public void dataSelect(){
        ...
        ekota.setText(""+model.getValueAt(i,2));
    ...
    public void simpanDataProduk(){
        ...
        try{
            ...
            String  sql =   "INSERT INTO tbl_pelanggan(kode, nama, kota, no)"
                            + "VALUES('"+ kode +"','"+ nama +"','"+ kota +"','"+ no +"')";
    ...
    public void rubahDataProduk(){
        ...
        try{
            ...
            //perintah sql untuk simpan data
            String sql  =   "UPDATE tbl_pelanggan SET nama  = '"+ nama +"',"
                            + "kota  = '"+ kota +"',"
                            + "no  = '"+ no +
                            "'WHERE kode = '" + kode +"'";
            PreparedStatement p = (PreparedStatement) koneksi.getKoneksi().prepareStatement(sql);
    ...
    public void hapusDataProduk(){
        ...
        if(pesan == JOptionPane.OK_OPTION){
            ...
            try{
                ...
                //perintah hapus data
                String sql = "DELETE FROM tbl_pelanggan WHERE kode='"+ kode +"'";
                PreparedStatement p =(PreparedStatement)koneksi.getKoneksi().prepareStatement(sql);
                p.executeUpdate();
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(enama)
                                .addComponent(eno)
                                .addComponent(ekota, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(44, 44, 44))
        );
